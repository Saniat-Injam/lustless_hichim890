...
class ThirdSuggestionPanic extends StatelessWidget {
  const ThirdSuggestionPanic({super.key});
  @override
    ...
    return Scaffold(
      body: Container(
        ...
        decoration: BoxDecoration(
           image: DecorationImage(image:AssetImage(ImagePath.thirdsuggestion),
          fit: BoxFit.cover,
        ),
      ),
           child: Column(
